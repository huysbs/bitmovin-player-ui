...
export namespace UIFactory {
  ...
  export function buildMyUI(player: PlayerAPI, config: UIConfig = {}): UIManager {
    return UIFactory.buildSimpleUI(player, config)
  }

  export function buildSimpleUI(player: PlayerAPI, config: UIConfig = {}): UIManager {
